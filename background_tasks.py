...
DB_FILE = os.path.join(PROJECT_DIR, "library_bcce0f55.db")
...
# --- دوال مساعدة ---
# تعديل دالة get_db_connection لاستخدام مدير قاعدة البيانات الجديد
def get_db_connection():
    try:
        # استيراد مدير قاعدة البيانات
        from db_manager import get_db_connection as get_managed_connection
        return get_managed_connection(DB_FILE)
    except ImportError:

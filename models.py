...
# تعديل تعريف المفاتيح الأساسية للتوافق مع DuckDB
# مثال لتعديل نموذج Settings

class Settings(db.Model):
    __tablename__ = 'settings'
    
    # استخدام autoincrement بدلاً من Sequence
...
class MediaFile(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('media_files_id_seq'), primary_key=True)
...
class Log(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('logs_id_seq'), primary_key=True)
...
class TranslationJob(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('translation_jobs_id_seq'), primary_key=True)
...
class Notification(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('notifications_id_seq'), primary_key=True)
...
class UserSession(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('user_sessions_id_seq'), primary_key=True)
...
class PasswordReset(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('password_resets_id_seq'), primary_key=True)
...
class TranslationHistory(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('translation_history_id_seq'), primary_key=True)
    media_file_id = db.Column(db.Integer, db.ForeignKey('media_files.id'), nullable=False)
...
class TranslationLog(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('translation_logs_id_seq'), primary_key=True)
...
class DatabaseStats(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('database_stats_id_seq'), primary_key=True)
...
class MediaService(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('media_services_id_seq'), primary_key=True)
...
class VideoFormat(db.Model):
    ...
    id = db.Column(db.Integer, Sequence('video_formats_id_seq'), primary_key=True)
